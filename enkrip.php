		...
		<div class="grid">
			<div class="row ">
				<div class="span8 offset2">
					...
					<h4>Plain Text:</h4>
					<br/>
					<form method="POST" action="simpanenk.php">
					<div class="input-control textarea">
						<textarea name="plain"><?php echo $isi; ?></textarea>
					</div>
					<br/>
					...
					<h4>Tabel Vigenere:</h4>
					<br/>
					<img src="img/vigenere-cipher.jpg" width="500" height="500" />
					<br/>
					
					<h4>Cipher Text:</h4>
					<br/>
					<div class="input-control textarea">
						<textarea name="cipher"><?php echo $cipher1; ?></textarea>
					</div>
					<br/>
